...
/// struct for typed errors of method [`get_sites`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`replace_site`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReplaceSiteError {
    Status400(crate::models::Error),
    Status404(crate::models::Error),
    DefaultResponse(crate::models::Error),
    UnknownValue(serde_json::Value),
...
pub async fn create_site(configuration: &configuration::Configuration, params: CreateSiteParams) -> Result<crate::models::Site, Error<CreateSiteError>> {
    ...
    let local_var_uri_str = format!("{}/services/haproxy/sites", local_var_configuration.base_path);
...
pub async fn delete_site(configuration: &configuration::Configuration, params: DeleteSiteParams) -> Result<(), Error<DeleteSiteError>> {
    ...
    let local_var_uri_str = format!("{}/services/haproxy/sites/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name));
...
pub async fn get_site(configuration: &configuration::Configuration, params: GetSiteParams) -> Result<crate::models::GetSite200Response, Error<GetSiteError>> {
    let local_var_configuration = configuration;
...
pub async fn get_sites(configuration: &configuration::Configuration, params: GetSitesParams) -> Result<crate::models::GetSites200Response, Error<GetSitesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSitesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn replace_site(configuration: &configuration::Configuration, params: ReplaceSiteParams) -> Result<crate::models::Site, Error<ReplaceSiteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReplaceSiteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
